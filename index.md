...
#### This dashboard I created on Tableau illustrates the transactional value of U.S. Healthcare Mergers & Acquisitions from 2009-2020. As depicted in the chart, 2015 was a very active year for Healthcare and Life Sciences M&A due to industry consolidation and loosened regulations. Examples of these large acquisitions include Pfizer’s $160 Billion takeover of Allergan and Anthem’s acquisition of Signa Corporation for $50.5 Billion. In direct contrast, Q2 2020 only has $21.5 Billion of Healthcare M&A transactional value, which is directly due to COVID-19. Based on the Healthcare and Lifesciences M&A trends illustrated in the second dashboard, there seems to be a negative trendline, but I foresee Healthcare M&A picking back up due to the healthcare’s sector resilience to recessions and underperforming economies. 
...
## **Tableau Map**
#### These dashboards made on Tableau show June 2020 Coronavirus cases in both the U.S. and abroad using John Hopkins University CSSE tracker for Coronavirus. My story points depict the disparity and disproportion of Coronavirus in the U.S. compared to other countries. 
